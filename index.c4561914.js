!function(){let t;var e,n,i,o,r,a,s,l,f,c="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function u(t,e){return function(){return t.apply(e,arguments)}}// utils is a library of generic helper functions non-specific to axios
...
X["-".charCodeAt(0)]=62,X["_".charCodeAt(0)]=63,l=function(t,e,n,i,o){var r,a,s=8*o-i-1,l=(1<<s)-1,f=l>>1,c=-7,u=n?o-1:0,p=n?-1:1,d=t[e+u];for(u+=p,r=d&(1<<-c)-1,d>>=-c,c+=s;c>0;r=256*r+t[e+u],u+=p,c-=8);for(a=r&(1<<-c)-1,r>>=-c,c+=i;c>0;a=256*a+t[e+u],u+=p,c-=8);if(0===r)r=1-f;else{if(r===l)return a?NaN:(d?-1:1)*(1/0);a+=Math.pow(2,i),r-=f}return(d?-1:1)*a*Math.pow(2,r-i)},f=function(t,e,n,i,o,r){var a,s,l,f=8*r-o-1,c=(1<<f)-1,u=c>>1,p=23===o?5960464477539062e-23:0,d=i?0:r-1,m=i?1:-1,h=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,a=c):(a=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-a))<1&&(a--,l*=2),a+u>=1?e+=p/l:e+=p*Math.pow(2,1-u),e*l>=2&&(a++,l/=2),a+u>=c?(s=0,a=c):a+u>=1?(s=(e*l-1)*Math.pow(2,o),a+=u):(s=e*Math.pow(2,u-1)*Math.pow(2,o),a=0));o>=8;t[n+d]=255&s,d+=m,s/=256,o-=8);for(a=a<<o|s,f+=o;f>0;t[n+d]=255&a,d+=m,a/=256,f-=8);t[n+d-m]|=128*h};let Z="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
let tv={};function tk(t,e,n){tv[t]=class extends n{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
...
// ================
let tC=/[^+/0-9A-Za-z-_]/g;function tO(t,e){let n;e=e||1/0;let i=t.length,o=null,r=[];for(let a=0;a<i;++a){// is surrogate component
...
let tR=function(){let t="0123456789abcdef",e=Array(256);for(let n=0;n<16;++n){let i=16*n;for(let o=0;o<16;++o)e[i+o]=t[n]+t[o]}return e}();// Return not function with Error if BigInt not supported
...
t=tz(t),!n&&e?"["+t+"]":t)}).join(n?".":""):e}let tP=H.toFlatObject(H,{},null,function(t){return/^is[A-Z]/.test(t)});var tF=/**
 ...
 *
 * @returns {void}
 */function t_(t,e){this._pairs=[],t&&tF(t,this,e)}let tW=t_.prototype;/**
 ...
 *
 * @returns {boolean}
 */let tK=("undefined"==typeof navigator||"ReactNative"!==(t=navigator.product)&&"NativeScript"!==t&&"NS"!==t)&&"undefined"!=typeof window&&"undefined"!=typeof document,tY="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
...
let t1=H.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
...
l.send(o||null)})};let ef={http:null,xhr:el};H.forEach(ef,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
e.data=t7.call(t,t.transformResponse,e),e.headers=t9.from(e.headers),e},function(e){return!et(e)&&(eu(t),e&&e.response&&(e.response.data=t7.call(t,t.transformResponse,e.response),e.response.headers=t9.from(e.response.headers))),Promise.reject(e)})}let ed=t=>t instanceof t9?t.toJSON():t;function em(t,e){// eslint-disable-next-line no-param-reassign
 ...
 *
 * @returns {object}
 */function(t,e,n){if("object"!=typeof t)throw new $("options must be an object",$.ERR_BAD_OPTION_VALUE);let i=Object.keys(t),o=i.length;for(;o-- >0;){let r=i[o],a=e[r];if(a){let e=t[r],n=void 0===e||a(e,r,t);if(!0!==n)throw new $("option "+r+" must be "+n,$.ERR_BAD_OPTION_VALUE);continue}if(!0!==n)throw new $("Unknown option "+r,$.ERR_BAD_OPTION)}},validators:eg};let ew=eb.validators;/**
...
let{Axios:eN,AxiosError:eA,CanceledError:eS,isCancel:eC,CancelToken:eO,VERSION:eB,all:eT,Cancel:eI,isAxiosError:eR,spread:eL,toFormData:eU,AxiosHeaders:ej,HttpStatusCode:ez,formToJSON:eD,getAdapter:eP,mergeConfig:eF}=eE,eM="https://api.thecatapi.com/v1/";eE.defaults.headers.common["x-api-key"]="live_Uczt18D595C6qQt0FV6BIE3pO0lPgMNJbt2vi6yynq9BhPO9UHt9Z5XcuGnVcxuF";var e_={};i=void 0!==c?c:"undefined"!=typeof window?window:e_,o=function(t){// COMMON: SSR check: begin
...
//     </div>`;
eH.catCard.innerHTML=r}(t)}).catch(t=>{(0,eW.Notify).failure(eH.err.textContent)}).finally(t=>(0,e_.Loading).remove())})}();//# sourceMappingURL=index.c4561914.js.map

//# sourceMappingURL=index.c4561914.js.map
